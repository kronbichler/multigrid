  ...
  if (contract_over_rows == true)
    {
      ...
      if (nn % 2 == 1)
        {
          Number r0 = (add_into ? array_for_add[mid] + coefficients_eo[mid * offset + mid] * xmid :
  ...
  else // contract_over_rows == false
    {
      ...
      if (nn % 2 == 1)
        {
          Number r0 =
            (add_into ? array_for_add[mid * stride] + coefficients_eo[mid * offset + mid] * xmid :
                        coefficients_eo[mid * offset + mid] * xmid);
          if (type == 1 && add_into)
